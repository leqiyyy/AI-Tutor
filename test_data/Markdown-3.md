...
![TCP报文格式](E:/download/img/computer_network/TCP报文结构.png)
...
![UDP报文格式](E:/download/img/computer_network/UDP报文格式.png)
...
![TCP三次握手的过程](E:/download/img/computer_network/三次握手.png)
...
![TCP四次挥手的过程](E:/download/img/computer_network/四次挥手.png)
...
![TCP四次挥手同时关闭](E:/download/img/computer_network/四次挥手同时关闭.png)
