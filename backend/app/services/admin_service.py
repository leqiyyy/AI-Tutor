    ...
    *,
    ...
    return {
        ...
        "retrieval": {
            ...
            "lightrag_max_total_tokens": getattr(settings, "RAG_LIGHTRAG_MAX_TOTAL_TOKENS", 12000),
            "source_rerank_enabled": getattr(settings, "RAG_SOURCE_RERANK_ENABLED", False),
            "mode_router_enabled": getattr(settings, "RAG_MODE_ROUTER_ENABLED", False),
            "mode_router_llm_fallback_enabled": getattr(settings, "RAG_MODE_ROUTER_LLM_FALLBACK_ENABLED", True),
            "mode_router_llm_min_confidence": getattr(settings, "RAG_MODE_ROUTER_LLM_MIN_CONFIDENCE", 0.68),
            "mode_router_llm_temperature": getattr(settings, "RAG_MODE_ROUTER_LLM_TEMPERATURE", 0.0),
            "mode_router_llm_top_p": getattr(settings, "RAG_MODE_ROUTER_LLM_TOP_P", 0.2),
            "mode_router_llm_max_tokens": getattr(settings, "RAG_MODE_ROUTER_LLM_MAX_TOKENS", 256),
            "mode_router_llm_enable_thinking": getattr(settings, "RAG_MODE_ROUTER_LLM_ENABLE_THINKING", False),
            "mode_router_llm_thinking_budget": getattr(settings, "RAG_MODE_ROUTER_LLM_THINKING_BUDGET", 0),
            "mode_router_small_kb_chunk_threshold": getattr(settings, "RAG_MODE_ROUTER_SMALL_KB_CHUNK_THRESHOLD", 30),
            "mode_router_medium_kb_chunk_threshold": getattr(settings, "RAG_MODE_ROUTER_MEDIUM_KB_CHUNK_THRESHOLD", 100),
            "mode_router_large_kb_chunk_threshold": getattr(settings, "RAG_MODE_ROUTER_LARGE_KB_CHUNK_THRESHOLD", 500),
