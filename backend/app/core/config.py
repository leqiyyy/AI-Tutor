...
class Settings(BaseSettings):
    ...
    CHAT_QUERY_TIMEOUT_SECONDS: int = 240
    ...
    RAG_LIGHTRAG_MAX_TOTAL_TOKENS: int = 12000
    RAG_SOURCE_RERANK_ENABLED: bool = False
    RAG_MODE_ROUTER_ENABLED: bool = False
    RAG_MODE_ROUTER_LLM_FALLBACK_ENABLED: bool = True
    RAG_MODE_ROUTER_LLM_MIN_CONFIDENCE: float = 0.68
    RAG_MODE_ROUTER_LLM_TEMPERATURE: float = 0.0
    RAG_MODE_ROUTER_LLM_TOP_P: float = 0.2
    RAG_MODE_ROUTER_LLM_MAX_TOKENS: int = 256
    RAG_MODE_ROUTER_LLM_ENABLE_THINKING: bool = False
    RAG_MODE_ROUTER_LLM_THINKING_BUDGET: int = 0
    RAG_MODE_ROUTER_SMALL_KB_CHUNK_THRESHOLD: int = 30
    RAG_MODE_ROUTER_MEDIUM_KB_CHUNK_THRESHOLD: int = 100
    RAG_MODE_ROUTER_LARGE_KB_CHUNK_THRESHOLD: int = 500
    ...
    RAG_KG_CONTEXT_FILTER_ENABLED: bool = True
    RAG_KG_CONTEXT_FILTER_VECTOR_FILE_LIMIT: int = 3
